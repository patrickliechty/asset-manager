...
function Content(pathPart, name, ext, type) {
  ...
  if(pathPart !== undefined) {
    ...
    // skip name mangling on angular files
    var skipMangle = this.meta && this.meta.mainFile && this.meta.mainFile.indexOf("js/angular/") >= 0;
    this.setContent(readContentSync(this.meta), type, skipMangle);
  }
}
