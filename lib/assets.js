...
jproto.preprocessContent = function preprocessContent() {};
...
coffeeProto.preprocessContent = function() {
  if(this.cr) {
    this.cr.setContent(coffeeScript.compile(this.cr.getContent('utf8')));
    jproto.preprocessContent.call(this);
  }
}
